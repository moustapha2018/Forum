 ...
 */
final class Version20190227171628 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_sujet (user_id INT NOT NULL, sujet_id INT NOT NULL, INDEX IDX_CCD1A2C57C4D497E (sujet_id), INDEX IDX_CCD1A2C5A76ED395 (user_id), PRIMARY KEY(user_id, sujet_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
